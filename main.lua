...
loadGitHub = function()
    ...
    loadFromGitHub("https://raw.githubusercontent.com/Nanskipp/space-fly/main/scripts/bullets.lua",
    function(obj)
        bullets = obj()
    end)
    loadFromGitHub("https://raw.githubusercontent.com/Nanskipp/space-fly/main/scripts/particles.lua",
    function(obj)
        particles = obj()
    end)
    ...
    loadFromGitHub("https://raw.githubusercontent.com/Nanskipp/space-fly/main/scripts/bonus.lua",
    function(obj)
        bonus = obj()
    end)
    loadFromGitHub("https://raw.githubusercontent.com/Nanskipp/space-fly/main/scripts/hud.lua",
    function(obj)
        hud = obj()
    end)
end
